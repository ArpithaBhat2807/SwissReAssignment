...
//        String filePath = "wrong_file.csv";
        ...
        Map<Integer, List<Employee>> managerToSubs = new HashMap<>();

        loadEmployees(filePath, employees, managerToSubs);

        checkManagerSalaries(employees, managerToSubs);
    ...
    private static void loadEmployees(String filePath,
                                      ...
                                      Map<Integer, List<Employee>> managerToSubs) throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(inputStream))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (managerId != null) {
                    managerToSubs.computeIfAbsent(managerId, k -> new ArrayList<>()).add(emp);
                }
            }
        }
    }
    ...
    private static void checkManagerSalaries(Map<Integer, Employee> employees,
                                             Map<Integer, List<Employee>> managerToSubs) {

        for (Integer managerId : managerToSubs.keySet()) {

            Employee manager = employees.get(managerId);
            List<Employee> subs = managerToSubs.get(managerId);
    ...
    private static void checkReportingLines(Map<Integer, Employee> employees) {
